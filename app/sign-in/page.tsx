  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-[1.05fr_1fr] bg-[#f8fafc] font-sans antialiased text-[#0f172a]">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 80% 20%, rgba(255,255,255,0.14), transparent 45%), radial-gradient(circle at 10% 90%, rgba(245,158,11,0.22), transparent 40%)",
        }}
      >
        {/* Logo */}
        <Link
        ...
        <div className="my-auto py-12 max-w-105">
          <div className="text-[#fbbf24] text-lg tracking-[2px] mb-4.5 font-mono">
            ★★★★★
          </div>
          ...
          <div className="flex items-center gap-3">
            <div className="w-10.5 h-10.5 rounded-full bg-white/20 shrink-0 flex items-center justify-center text-white text-sm font-bold border border-white/10">
              SR
            </div>
            <div>
