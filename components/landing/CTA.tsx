...
export default function CTA() {
  return (
    <section className="max-w-300 mx-auto px-8 pb-20">
      ...
      >
        {/* Title */}
        <h2 className="text-[32px] sm:text-[42px] font-extrabold tracking-tight text-white max-w-140 mx-auto leading-tight">
          Ready to give your team momentum?
        </h2>

        {/* Description */}
        <p className="text-base sm:text-lg text-slate-400 mt-4.5 mb-8 max-w-120 mx-auto leading-[1.55]">
        ...
        <div className="flex flex-col sm:flex-row gap-3.5 justify-center w-full sm:w-auto z-10">
          <Link href="/sign-up" className="w-full sm:w-auto">
            <button className="btn-brand-secondary border-none px-7 w-full">
              Start for free
            </button>
          </Link>
          <button className="btn-brand-dark px-7">Talk to sales</button>
        </div>
      </div>
    </section>
  );
